...
model PCL_WithHeatSource_withController_StandAlone1
...
equation
  ...
  connect(boundary4.ports[1], SHX.port_a_tube) annotation (Line(points={{
          136,-16},{80,-16},{80,-4}}, color={0,127,255}));
  connect(boundary1.ports[1], SHX.port_b_tube) annotation (Line(points={{
          144,36},{80,36},{80,16}}, color={0,127,255}));
...
end PCL_WithHeatSource_withController_StandAlone1;
