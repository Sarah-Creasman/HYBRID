...
equation
  ...
  connect(pCL_WithHeatSource.port_b, BOP.port_a_steam) annotation (Line(points=
          {{-9,33.2},{46,33.2},{46,28},{56,28}}, color={0,127,255}));
  connect(pCL_WithHeatSource.port_a, BOP.port_b_feed) annotation (Line(points={
...
<p>Runs for 1e6 seconds, not checked for a longer time.</p>
