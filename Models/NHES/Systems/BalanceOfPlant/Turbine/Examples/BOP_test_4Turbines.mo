...
equation
  ...
  connect(PHS.port_a, BOP.port_a_steam) annotation (Line(points={{-14,32},{48,32},
          {48,28},{58,28}}, color={0,127,255}));
  connect(PHS.port_b, BOP.port_b_feed) annotation (Line(points={{-14,40},{-4,40},
          {-4,-10},{50,-10},{50,-8},{58,-8}}, color={0,127,255}));
