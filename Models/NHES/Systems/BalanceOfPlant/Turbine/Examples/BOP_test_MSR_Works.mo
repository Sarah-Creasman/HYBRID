...
model BOP_test_MSR_Works
  ...
  PrimaryHeatSystem.MSR.Examples.MCA_Base_withBOP_sec_2_Works
    mCA_Base_withBOP_sec_2_Works
    annotation (Placement(transformation(extent={{-54,26},{-34,48}})));
initial equation
...
equation
  ...
  connect(BOP.port_b_feed, mCA_Base_withBOP_sec_2_Works.port_a) annotation (
      Line(points={{56,-8},{46,-8},{46,33.48},{-8.2,33.48}}, color={0,127,255}));
  connect(mCA_Base_withBOP_sec_2_Works.port_b, BOP.port_a_steam) annotation (
      Line(points={{-8.8,40.74},{-8.8,44},{20,44},{20,36},{48,36},{48,28},{56,
          28}}, color={0,127,255}));
  annotation (experiment(StopTime=10000000, __Dymola_Algorithm="Esdirk45a"),
                                       Documentation(info="<html>
<p>Runs well for 1e7 seconds</p>
