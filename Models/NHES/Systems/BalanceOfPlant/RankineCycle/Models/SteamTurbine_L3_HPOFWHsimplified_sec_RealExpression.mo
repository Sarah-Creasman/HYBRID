...
model SteamTurbine_L3_HPOFWHsimplified_sec_RealExpression
  ...
  Modelica.Blocks.Sources.RealExpression realExpression(y=0.6985)
...
equation
  ...
  connect(realExpression.y, HPT_bypass_valve.opening) annotation (Line(points={
          {-3,-8},{-6,-8},{-6,-16},{-12,-16}}, color={0,0,127}));
...
end SteamTurbine_L3_HPOFWHsimplified_sec_RealExpression;
