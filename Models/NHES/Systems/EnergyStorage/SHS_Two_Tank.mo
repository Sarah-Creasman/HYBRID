    ...
    model Build_Test
      ...
      NHES.Systems.EnergyStorage.SHS_Two_Tank.Components.Two_Tank_SHS_System
        ...
        redeclare replaceable
          ...
          ht_init_level=10.01/2,
          cold_tank_init_level=10.01/2,
...
<p>System is based upon report: Frick, Konor L. Status Report on the NuScale Module Developed in the Modelica Framework. United States: N. p., 2019. Web. doi:10.2172/1569288.</p>
  ...
  package Components
    ...
    equation
      ...
      connect(flowMultiplier1.port_a, hot_tank_dump_pipe.port_b) annotation (
          Line(points={{38,-50},{32,-50},{32,-56},{34,-56},{34,-70},{30,-70}},
            color={0,127,255}));
    ...
    model Two_Tank_SHS_System_old_sec
      extends BaseClasses.Partial_SubSystem_A(
        redeclare replaceable ControlSystems.CS_Boiler_02 CS,
        redeclare replaceable ED_Dummy ED,
        redeclare replaceable Data.Data_SHS data);
    ...
    equation
      ...
      connect(boundary2.h_in, delay1.y)
        annotation (Line(points={{-46,-90},{-53.44,-90}}, color={0,0,127}));
      connect(hot_tank.port_b, discharge_pump.port_a) annotation (Line(points={
              {48,-92.4},{48,-98},{82,-98},{82,-76}}, color={0,127,255}));
      annotation (experiment(
          StopTime=432000,
          Interval=37,
          __Dymola_Algorithm="Esdirk45a"), Icon(graphics={
            ...
            Rectangle(
              ...
              fillPattern=FillPattern.HorizontalCylinder,
              lineThickness=1)}));
    end Two_Tank_SHS_System_old_sec;
  end Components;
