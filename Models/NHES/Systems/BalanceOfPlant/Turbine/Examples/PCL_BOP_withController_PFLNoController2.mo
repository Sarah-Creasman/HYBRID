...
model PCL_BOP_withController_PFLNoController2
  ...
  PrimaryHeatSystem.MSR.Examples.PCL_PortsBothSides pCL_PortsBothSides
    annotation (Placement(transformation(extent={{-22,20},{-2,40}})));
  PrimaryHeatSystem.MSR.Examples.MCA_Base_withBOP_PFL_NoPHX
    mCA_Base_withBOP_PFL_NoPHX
...
equation
  ...
  connect(pCL_PortsBothSides.port_b, BOP.port_a_steam) annotation (Line(points=
          {{4.4,34.6},{46,34.6},{46,28},{56,28}}, color={0,127,255}));
  connect(pCL_PortsBothSides.port_a, BOP.port_b_feed) annotation (Line(points={
          {0.2,27.2},{6,27.2},{6,-10},{48,-10},{48,-8},{56,-8}}, color={0,127,
          255}));
  connect(pCL_PortsBothSides.port_b1, mCA_Base_withBOP_PFL_NoPHX.port_a)
    annotation (Line(points={{-26.8,29.4},{-100,29.4},{-100,44.6},{-104,44.6}},
        color={0,127,255}));
  connect(mCA_Base_withBOP_PFL_NoPHX.port_b, pCL_PortsBothSides.port_a1)
    annotation (Line(points={{-103.4,38.6},{-108,38.6},{-108,48},{-34,48},{-34,
          34.8},{-28.8,34.8}}, color={0,127,255}));
  annotation (experiment(
      StopTime=100000,
      Interval=5,
      __Dymola_Algorithm="Esdirk45a"), Documentation(info="<html>
<p>Errors: The parts of</p><p>(mCA_Base_withBOP_PFL_NoPHX.pipeToPHX_PFL.port_b.C_outflow_inStream) = ( pCL_PortsBothSides.port_b1.C_outflow)</p><p>have incompatible sizes: [274] and [0].</p>
...
end PCL_BOP_withController_PFLNoController2;
