...
//  extends TRANSFORM.Icons.Example;
  ...
  extends MSR.BaseClasses.Partial_SubSystem_A(
    redeclare replaceable MSR.ControlSystems.CS_MSR_PFL CS,
    redeclare replaceable MSR.ControlSystems.ED_Dummy ED,
    redeclare MSR.Data.fissionProducts_1a data);
...
public
  ...
  MSR.SupportComponents.GenericPipe_forMSRs reflA_upper(
    C_a_start=Cs_start,
  ...
  MSR.SupportComponents.MixingVolume_forMSRs plenum_upper(
    ...
    showName=systemTF.showName) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={0,90})));
  MSR.SupportComponents.GenericPipe_forMSRs reflA_lower(
    C_a_start=Cs_start,
    m_flow_a_start=data_MSR.m_flow,
  ...
  MSR.SupportComponents.MixingVolume_forMSRs tee_inlet(
    ...
    showName=systemTF.showName) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={0,-130})));
  MSR.SupportComponents.GenericPipe_forMSRs pipeFromPHX_PFL(
    nParallel=3,
    T_a_start=data_MSR.T_outlet_tube,
    redeclare package Medium = Medium_PFL,
  ...
  MSR.SupportComponents.GenericDistributed_HX_withMass_forMSRs PHX(
  ...
  MSR.SupportComponents.GenericPipe_forMSRs pipeToPHX_PFL(
    nParallel=3,
    redeclare package Medium = Medium_PFL,
  ...
  MSR.SupportComponents.ExpansionTank pumpBowl_PFL(
    redeclare package Medium = Medium_PFL,
    p_start=data_MSR.p_inlet_tube,
  ...
  MSR.SupportComponents.GenericPipe_forMSRs reflR(
    C_a_start=Cs_start,
    redeclare model HeatTransfer =
        TRANSFORM.Fluid.ClosureRelations.HeatTransfer.Models.DistributedPipe_1D_MultiTransferSurface.Nus_SinglePhase_2Region,
    T_a_start=data_MSR.T_outlet_tube,
...
public
  TRANSFORM.Units.NonDim mC_plenum_upper[kinetics.data.nC + kinetics.reactivity.data.nC]
    =plenum_upper.mC;
  TRANSFORM.Units.NonDim mC_plenum_lower[kinetics.data.nC + kinetics.reactivity.data.nC]
    =plenum_lower.mC;
  TRANSFORM.Units.NonDim mC_tee_inlet[kinetics.data.nC + kinetics.reactivity.data.nC]
    =tee_inlet.mC;
  TRANSFORM.Units.NonDim mC_pumpBowl_PFL[kinetics.data.nC + kinetics.reactivity.data.nC]
    =pumpBowl_PFL.mC;
  TRANSFORM.Units.NonDim mC_drainTank_gas[kinetics.data.nC + kinetics.reactivity.data.nC]
    =drainTank_gas.mC;
  TRANSFORM.Units.NonDim mC_drainTank_liquid[kinetics.data.nC + kinetics.reactivity.data.nC]
    =drainTank_liquid.mC;
  TRANSFORM.Units.NonDim mCs_fuelCell[fuelCell.nV,kinetics.data.nC + kinetics.reactivity.data.nC]
    =fuelCell.mCs;
  TRANSFORM.Units.NonDim mCs_reflA_upper[reflA_upper.nV,kinetics.data.nC +
    kinetics.reactivity.data.nC]=reflA_upper.mCs;
  TRANSFORM.Units.NonDim mCs_reflA_lower[reflA_lower.nV,kinetics.data.nC +
    kinetics.reactivity.data.nC]=reflA_lower.mCs;
  TRANSFORM.Units.NonDim mCs_pipeFromPHX_PFL[pipeFromPHX_PFL.nV,kinetics.data.nC
     + kinetics.reactivity.data.nC]=pipeFromPHX_PFL.mCs;
  TRANSFORM.Units.NonDim mCs_PHX_tube[PHX.tube.nV,kinetics.data.nC + kinetics.reactivity.data.nC]
    =PHX.tube.mCs;
  TRANSFORM.Units.NonDim mCs_pipeToPHX_PFL[pipeToPHX_PFL.nV,kinetics.data.nC +
    kinetics.reactivity.data.nC]=pipeToPHX_PFL.mCs;
  TRANSFORM.Units.NonDim mCs_reflR[reflR.nV,kinetics.data.nC + kinetics.reactivity.data.nC]
    =reflR.mCs;

  // atoms component total
  TRANSFORM.Units.NonDim mC_plenum_upper_total[kinetics.data.nC + kinetics.reactivity.data.nC]
    =plenum_upper.mC;
  TRANSFORM.Units.NonDim mC_plenum_lower_total[kinetics.data.nC + kinetics.reactivity.data.nC]
    =plenum_lower.mC;
  TRANSFORM.Units.NonDim mC_tee_inlet_total[kinetics.data.nC + kinetics.reactivity.data.nC]
    =tee_inlet.mC;
  TRANSFORM.Units.NonDim mC_pumpBowl_PFL_total[kinetics.data.nC + kinetics.reactivity.data.nC]
    =pumpBowl_PFL.mC;
  TRANSFORM.Units.NonDim mC_drainTank_gas_total[kinetics.data.nC + kinetics.reactivity.data.nC]
    =drainTank_gas.mC;
  TRANSFORM.Units.NonDim mC_drainTank_liquid_total[kinetics.data.nC + kinetics.reactivity.data.nC]
    =drainTank_liquid.mC;
  TRANSFORM.Units.NonDim mCs_fuelCell_total[kinetics.data.nC + kinetics.reactivity.data.nC]
    ={sum(fuelCell.mCs[:, i])*fuelCell.nParallel for i in 1:kinetics.data.nC +
      kinetics.reactivity.data.nC};
  TRANSFORM.Units.NonDim mCs_reflA_upper_total[kinetics.data.nC + kinetics.reactivity.data.nC]
    ={sum(reflA_upper.mCs[:, i])*reflA_upper.nParallel for i in 1:kinetics.data.nC
       + kinetics.reactivity.data.nC};
  TRANSFORM.Units.NonDim mCs_reflA_lower_total[kinetics.data.nC + kinetics.reactivity.data.nC]
    ={sum(reflA_lower.mCs[:, i])*reflA_lower.nParallel for i in 1:kinetics.data.nC
       + kinetics.reactivity.data.nC};
  TRANSFORM.Units.NonDim mCs_pipeFromPHX_PFL_total[kinetics.data.nC + kinetics.reactivity.data.nC]
    ={sum(pipeFromPHX_PFL.mCs[:, i])*pipeFromPHX_PFL.nParallel for i in 1:
      kinetics.data.nC + kinetics.reactivity.data.nC};
  TRANSFORM.Units.NonDim mCs_PHX_tube_total[kinetics.data.nC + kinetics.reactivity.data.nC]
    ={sum(PHX.tube.mCs[:, i])*PHX.tube.nParallel for i in 1:kinetics.data.nC +
      kinetics.reactivity.data.nC};
  TRANSFORM.Units.NonDim mCs_pipeToPHX_PFL_total[kinetics.data.nC + kinetics.reactivity.data.nC]
    ={sum(pipeToPHX_PFL.mCs[:, i])*pipeToPHX_PFL.nParallel for i in 1:kinetics.data.nC
       + kinetics.reactivity.data.nC};
  TRANSFORM.Units.NonDim mCs_reflR_total[kinetics.data.nC + kinetics.reactivity.data.nC]
    ={sum(reflR.mCs[:, i])*reflR.nParallel for i in 1:kinetics.data.nC +
      kinetics.reactivity.data.nC};

  // atoms total
  TRANSFORM.Units.NonDim mC_total[kinetics.data.nC + kinetics.reactivity.data.nC]
    ={mC_plenum_upper_total[i] + mC_plenum_lower_total[i] + mC_tee_inlet_total[
      i] + mC_pumpBowl_PFL_total[i] + mC_drainTank_gas_total[i] +
      mC_drainTank_liquid_total[i] + mCs_fuelCell_total[i] +
      mCs_reflA_upper_total[i] + mCs_reflA_lower_total[i] +
      mCs_pipeFromPHX_PFL_total[i] + mCs_PHX_tube_total[i] +
      mCs_pipeToPHX_PFL_total[i] + mCs_reflR_total[i] for i in 1:kinetics.data.nC
       + kinetics.reactivity.data.nC};
...
protected
  ...
  TRANSFORM.HeatAndMassTransfer.BoundaryConditions.Heat.Temperature_multi
    ...
    showName=systemTF.showName) annotation (Placement(transformation(
        ...
        rotation=270,
        origin={-268,18})));
  MSR.SupportComponents.MixingVolume_forMSRs drainTank_gas(
    use_HeatPort=true,
    redeclare package Medium = Medium_OffGas,
  ...
  MSR.SupportComponents.ExpansionTank drainTank_liquid(
    redeclare package Medium = Medium_PFL,
