...
model NSSS_Test_b_SEC3_RealExpression
...
//  Real eta_CHP "Thermal Cycle Efficiency";
  ...
  Models.SteamTurbine_L3_HPOFWHsimplified_sec_RealExpressionswitch BOP(
  ...
  NHES.Systems.BalanceOfPlant.RankineCycle.Data.Data_4Turbines data(
    ...
    d_LPT1_in(displayUnit="kg/m3") = 7.651232195,
    d_LPT2_in(displayUnit="kg/m3") = 6.174594994,
    mdot_total=2019.662582,
    mdot_fh=561.3394602,
    mdpt_HPFH=280,
    mdot_hpt=1458.323122,
    mdot_lpt1=1458.323122,
    mdot_lpt2=1262.975591,
    m_ext=m_ext,
    eta_t=0.9,
    eta_mech=1,
    eta_p=0.8)
...
end NSSS_Test_b_SEC3_RealExpression;
