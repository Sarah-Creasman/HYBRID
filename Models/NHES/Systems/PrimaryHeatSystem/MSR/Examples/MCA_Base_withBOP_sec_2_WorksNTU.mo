...
model MCA_Base_withBOP_sec_2_WorksNTU
...
public
  ...
  Modelica.Fluid.Interfaces.FluidPort_a port_a(redeclare package Medium =
    ...
    annotation (Placement(transformation(extent={{408,-72},{428,-52}})));
  Modelica.Fluid.Interfaces.FluidPort_b port_b(redeclare package Medium =
        Modelica.Media.Water.StandardWater)
    annotation (Placement(transformation(extent={{402,-6},{422,14}})));
protected
...
equation
  ...
  connect(nTU_HX_SinglePhase.Tube_out, port_a) annotation (Line(points={{
          290,-14},{290,-62},{418,-62}}, color={0,127,255}));
  connect(port_b, nTU_HX_SinglePhase.Tube_in) annotation (Line(points={{412,
          4},{308,4},{308,6},{290,6}}, color={0,127,255}));
  annotation (
...
end MCA_Base_withBOP_sec_2_WorksNTU;
