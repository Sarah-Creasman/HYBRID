...
model SteamTurbine_L3_HPOFWHsimplified_sec_RealExpressionswitch
  ...
  Modelica.Blocks.Sources.RealExpression realExpression(y=0.6939)
    annotation (Placement(transformation(extent={{30,0},{10,20}})));
  Modelica.Blocks.Logical.Switch switch1
    annotation (Placement(transformation(extent={{66,-20},{46,0}})));
  Modelica.Blocks.Sources.BooleanStep booleanStep1(startTime=7.5e4, startValue=
...
equation
  ...
  connect(actuatorBus.opening_TCV, TCV.opening) annotation (Line(
      points={{30.1,100.1},{-56,100.1},{-56,58},{-64,58},{-64,54}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5), Text(
      string="%first",
  ...
  connect(TCV.port_a, port_a_steam) annotation (Line(points={{-74,46},{-100,46},
          {-100,60}},         color={0,127,255}));
  connect(TCV.port_b, delay2_1.port_a)
    annotation (Line(points={{-54,46},{-48,46},{-48,74},{-34,74}},
                                                          color={0,127,255}));
  ...
  connect(port_a_steam, LPT1_bypass_valve.port_a) annotation (Line(points={{
          -100,60},{-100,40},{-102,40},{-102,14},{-114,14},{-114,-14},{-38,-14},
...
end SteamTurbine_L3_HPOFWHsimplified_sec_RealExpressionswitch;
