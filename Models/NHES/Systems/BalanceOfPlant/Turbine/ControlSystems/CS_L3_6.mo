...
model CS_L3_6
  ...
  LimOffsetPID              LPT2_BV_PID(controllerType=Modelica.Blocks.Types.SimpleController.PI,
    k=1e-5,
    Ti=15,
    yMax=1,
    yMin=0,
...
equation
  ...
  connect(sensorBus.Extract_flow, LPT1_BV_PID.u_m) annotation (Line(
      ...
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(P_in_set.y, LPT2_BV_PID1.u_s) annotation (Line(points={{-79,10},{-26,
          10},{-26,8},{-18,8}}, color={0,0,127}));
  connect(sensorBus.Steam_Pressure, LPT2_BV_PID1.u_m) annotation (Line(
      points={{-30,-100},{-30,-14},{-6,-14},{-6,-4}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5), Text(
      string="%first",
      ...
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(actuatorBus.opening_TCV, LPT2_BV_PID1.y) annotation (Line(
      points={{30.1,-99.9},{30.1,8},{5,8}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5), Text(
      string="%first",
