...
equation
  ...
  connect(sensorBus.SG_pressure, sensor_p.p) annotation (Line(
      ...
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(port_a1, PHX.port_a_tube) annotation (Line(points={{-168,48},{-60,
          48},{-60,16}}, color={0,127,255}));
  connect(port_b1, PHX.port_b_tube) annotation (Line(points={{-148,-6},{-76,
          -6},{-76,-10},{-60,-10},{-60,-4}}, color={0,127,255}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
        coordinateSystem(preserveAspectRatio=false)),
    experiment(StopTime=10000000, __Dymola_Algorithm="Esdirk45a"));
end PCL_PortsBothSides;
