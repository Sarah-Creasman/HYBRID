...
model TEDSloop_ConnectHTSE_SEC
  "The TEDS loop from TEDSloop_allmodes_test duplicated for connection to HTSE"
  ...
  Control_Systems.Control_System_Therminol_4_element_all_modes control_System_Therminol_4_element_all_modes_connect_htse_sec(
    redeclare package Medium =
        TRANSFORM.Media.Fluids.Therminol_66.LinearTherminol66_A_250C,
    T_hot_design=598.15,
  ...
  Modelica.Blocks.Sources.Constant const1(k=
        control_System_Therminol_4_element_all_modes_connect_htse_sec.T_cold_design)
    annotation (Placement(transformation(
        extent={{4,-4},{-4,4}},
        rotation=0,
        origin={12,-184})));
  ...
  Modelica.Blocks.Sources.Constant const(k=
        control_System_Therminol_4_element_all_modes_connect_htse_sec.T_hot_design)
    annotation (Placement(transformation(
        extent={{-6,-6},{6,6}},
        rotation=0,
        origin={-146,46})));
...
equation
  ...
  connect(control_System_Therminol_4_element_all_modes_connect_htse_sec.actuatorSubBus,
    actuatorSubBus) annotation (Line(
      points={{30.7067,118.092},{30.7067,106},{-31,106}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(control_System_Therminol_4_element_all_modes_connect_htse_sec.sensorSubBus,
