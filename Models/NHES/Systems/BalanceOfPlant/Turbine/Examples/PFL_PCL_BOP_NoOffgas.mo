...
model PFL_PCL_BOP_NoOffgas
  ...
  PrimaryHeatSystem.MSR.Examples.PFL_AddControlSystem_Portsfix_NoOffgas
    pFL_AddControlSystem_Portsfix_NoOffgas
...
equation
  ...
  connect(pCL_PortsBothSides_NoPHX.port_a, BOP.port_b_feed) annotation (Line(
        ...
        color={0,127,255}));
  connect(pFL_AddControlSystem_Portsfix_NoOffgas.port_b,
    pCL_PortsBothSides_NoPHX.port_a1) annotation (Line(points={{-93.8,35},{
          -93.8,34.6},{-43.8,34.6}}, color={0,127,255}));
  connect(pFL_AddControlSystem_Portsfix_NoOffgas.port_a,
    pCL_PortsBothSides_NoPHX.port_b1) annotation (Line(points={{-93.4,28.8},{
          -93.4,24},{-50,24},{-50,27.4},{-43.8,27.4}}, color={0,127,255}));
