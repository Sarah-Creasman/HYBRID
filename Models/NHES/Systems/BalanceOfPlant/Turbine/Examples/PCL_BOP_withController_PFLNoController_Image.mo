...
model PCL_BOP_withController_PFLNoController_Image
  ...
  TRANSFORM.Fluid.BoundaryConditions.Boundary_pT bypass(
...
equation
  ...
  connect(bypass.ports[1], BOP.port_b_bypass) annotation (Line(points={{-18,-59},
          {-18,-60},{-6,-60},{-6,10},{56,10}}, color={0,127,255}));
  ...
  connect(pCL_PortsBothSides_NoPHX.port_b, BOP.port_a_steam) annotation (Line(
        points={{-24.54,25.44},{48,25.44},{48,28},{56,28}},
                                                         color={0,127,255}));
  connect(pCL_PortsBothSides_NoPHX.port_a, BOP.port_b_feed) annotation (Line(
        points={{-24.54,5.28},{46,5.28},{46,-8},{56,-8}},
        color={0,127,255}));
  connect(pCL_PortsBothSides_NoPHX.port_a1, mCA_Base_withBOP_PFL_Only.port_b)
    annotation (Line(points={{-77.46,24.88},{-94,24.88},{-94,24.88},{-106,24.88}},
                                                                      color={0,
          127,255}));
  connect(mCA_Base_withBOP_PFL_Only.port_a, pCL_PortsBothSides_NoPHX.port_b1)
    annotation (Line(points={{-106,4.9},{-91.73,4.9},{-91.73,4.72},{-77.46,4.72}},
        color={0,127,255}));
...
end PCL_BOP_withController_PFLNoController_Image;
