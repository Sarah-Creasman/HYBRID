...
//  MSR.MoltenSaltReactor.Data.data_MSR data_MSR annotation (Placement(transformation(extent={{260,80},{280,100}})));
  ...
  TRANSFORM.Examples.MoltenSaltReactor.Data.Summary summary(
    ...
    T_tube_inlet_SHX=274.15,
    T_tube_outlet_SHX=274.15,
    p_inlet_tube_SHX=100000,
    dp_tube_SHX=100000,
    m_flow_tube_SHX=1,
    T_shell_inlet_SHX=274.15,
    T_shell_outlet_SHX=274.15,
    p_inlet_shell_SHX=100000,
    dp_shell_SHX=100000,
    m_flow_shell_SHX=1,
    nTubes_SHX=1,
    diameter_outer_tube_SHX=1,
    th_tube_SHX=1,
    length_tube_SHX=1,
...
public
  ...
  Fluid.HeatExchangers.Generic_HXs.NTU_HX_SinglePhase nTU_HX_SinglePhase(
    K_tube=1,
    K_shell=1,
      redeclare package Tube_medium = Medium_BOP, redeclare package
      Shell_medium = Medium_PCL,
    use_T_start_tube=true,
    T_start_tube_inlet=573.15,
    T_start_tube_outlet=788.15,
    use_T_start_shell=true,
    T_start_shell_inlet=866.15,
    T_start_shell_outlet=755.15,
    dp_general=100,
    Cr_init=0.0,
    m_start_shell=10)            annotation (Placement(transformation(
        extent={{-10,10},{10,-10}},
        rotation=90,
        origin={292,2})));
protected
...
equation
  ...
  connect(nTU_HX_SinglePhase.Shell_in, pipeToPHX_PCL.port_a) annotation (Line(
        points={{290,-8},{290,-40},{240,-40}}, color={0,127,255}));
  connect(pipeToSHX_PCL.port_b, nTU_HX_SinglePhase.Shell_out)
    annotation (Line(points={{290,40},{290,12}}, color={0,127,255}));
  connect(nTU_HX_SinglePhase.Tube_in, port_b) annotation (Line(points={{296,12},
          {296,24},{332,24},{332,34},{352,34}}, color={0,127,255}));
  connect(nTU_HX_SinglePhase.Tube_out, port_a) annotation (Line(points={{296,-8},
          {296,-32},{358,-32}}, color={0,127,255}));
  annotation (
