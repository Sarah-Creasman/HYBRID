...
model NSSS_Test_b_SEC3_RealExpression_MoveFWHExtraction_30
...
//  Real eta_CHP "Thermal Cycle Efficiency";
  ...
  Models.SteamTurbine_L3_HPOFWHsimplified_sec_RealExpressionswitch_FWHExtractionLPT BOP(
  ...
  NHES.Systems.BalanceOfPlant.RankineCycle.Data.Data_4Turbines data(
    ...
    d_LPT1_in(displayUnit="kg/m3") = 21.19101896,
    d_LPT2_in(displayUnit="kg/m3") = 6.174594994,
    mdot_total=1413.763807,
    mdot_fh=374.2817,
    mdpt_HPFH=280,
    mdot_hpt=1413.763807,
    mdot_lpt1=1039.482107,
    mdot_lpt2=899.877236,
    m_ext=m_ext,
    eta_t=0.9,
    eta_mech=1,
    eta_p=0.8)
...
end NSSS_Test_b_SEC3_RealExpression_MoveFWHExtraction_30;
