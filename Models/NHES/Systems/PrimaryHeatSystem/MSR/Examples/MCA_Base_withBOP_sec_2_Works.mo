...
model MCA_Base_withBOP_sec_2_Works
...
equation
  ...
  connect(port_a, SHX.port_a_tube) annotation (Line(points={{358,-32},{300,
          -32},{300,-10}}, color={0,127,255}));
  connect(port_b, SHX.port_b_tube) annotation (Line(points={{352,34},{300,
          34},{300,10}}, color={0,127,255}));
  annotation (
...
end MCA_Base_withBOP_sec_2_Works;
