...
model PFL_AddControlSystem_SmallData

//  extends TRANSFORM.Icons.Example;

  import TRANSFORM;
  extends BaseClasses.Partial_SubSystem_A( redeclare replaceable MSR.CS.CS_MSR_PFL CS,
...
//  constant SIadd.Mole mol_salt_total = m_salt_total/Medium
...
//        for i in 1:nA};
  ...
  //  constant Real mCs_start_salt[size(i_mCs_start_salt, 1)]={m_actinide*(if i ==2 then x_actinide[i]/x_actinide[1] else 1.0)/MW[i]*Modelica.Constants.N_A for i in 1:nA};
...
end PFL_AddControlSystem_SmallData;
