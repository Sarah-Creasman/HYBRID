...
model NSSS_Test_b_SEC_RemoveReactor
...
//  Real eta_CHP "Thermal Cycle Efficiency";
  ...
  Models.SteamTurbine_L3_HPOFWHsimplified_sec_RemoveReactorVersion BOP(
  ...
  NHES.Systems.BalanceOfPlant.RankineCycle.Data.Data_4Turbines data(
    ...
    d_LPT1_in(displayUnit="kg/m3") = 6.12565019,
    d_LPT2_in(displayUnit="kg/m3") = 6.12565019,
    mdot_total=2019.662582,
    mdot_fh=561.3666201,
    mdpt_HPFH=20,
    mdot_hpt=1458.295962,
    mdot_lpt1=1458.295962,
    mdot_lpt2=1262.529559,
    m_ext=m_ext)
  ...
  TRANSFORM.HeatAndMassTransfer.BoundaryConditions.Heat.HeatFlow
    boundary2(Q_flow=3651e6)
    annotation (Placement(transformation(extent={{-116,28},{-104,40}})));
initial equation
...
//  eta_CHP=(-BOP.port_a_elec.W-BOP.pump.W-BOP.pump1.W-BOP.FWCP.W+Q_util)/volume.heatPort.Q_flow;
  ...
  connect(stateSensor2.port_b, volume.port_a) annotation (Line(points={{-38,-10},
          {-80,-10},{-80,34}}, color={0,127,255}));
  connect(boundary2.port, volume.heatPort) annotation (Line(points={{-104,34},{
          -96,34},{-96,40},{-86,40}}, color={191,0,0}));
...
end NSSS_Test_b_SEC_RemoveReactor;
