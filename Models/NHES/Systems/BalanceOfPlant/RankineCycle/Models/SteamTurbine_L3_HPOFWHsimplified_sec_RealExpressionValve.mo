...
model SteamTurbine_L3_HPOFWHsimplified_sec_RealExpressionValve
  ...
  Modelica.Blocks.Sources.RealExpression realExpression(y=0.03)
...
equation
  ...
  connect(realExpression.y, HPT_bypass_valve.opening)
    annotation (Line(points={{7,-16},{-12,-16}}, color={0,0,127}));
...
end SteamTurbine_L3_HPOFWHsimplified_sec_RealExpressionValve;
