...
model PCL_WithHeatSource_withController_BOP_Ports
  ...
  Modelica.Fluid.Interfaces.FluidPort_a port_a(redeclare package Medium =
        Medium_BOP)
    annotation (Placement(transformation(extent={{144,-32},{164,-12}})));
...
equation
  ...
  connect(SHX.port_b_tube, port_b)
    annotation (Line(points={{80,16},{80,40},{154,40}}, color={0,127,255}));
  connect(SHX.port_a_tube, port_a)
    annotation (Line(points={{80,-4},{80,-22},{154,-22}}, color={0,127,255}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
        coordinateSystem(preserveAspectRatio=false)),
    experiment(StopTime=10000000, __Dymola_Algorithm="Esdirk45a"));
end PCL_WithHeatSource_withController_BOP_Ports;
