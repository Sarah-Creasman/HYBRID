...
model PCL_BOP_withController
  ...
  PrimaryHeatSystem.MSR.Examples.PCL_WithHeatSource_withController
    pCL_WithHeatSource_withController(
    toggleStaticHead=0,
    nV_fuelCell=2,
    nV_PHX=2,
    nV_SHX=2,
...
equation
  ...
  connect(pCL_WithHeatSource_withController.port_a, BOP.port_b_feed)
...
<p>Successful run of 1e6 seconds.</p>
