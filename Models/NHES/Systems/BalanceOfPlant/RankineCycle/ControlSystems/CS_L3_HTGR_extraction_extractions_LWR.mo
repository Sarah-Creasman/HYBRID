...
model CS_L3_HTGR_extraction_extractions_LWR
  ...
  Controls.LimOffsetPID     TCV_PID(controllerType=Modelica.Blocks.Types.SimpleController.PI,
    k=-5e-10,
    Ti=360,
    yMax=1,
    yMin=0.00001,
  ...
  Modelica.Blocks.Sources.BooleanStep booleanStep1(startTime=120000)
  ...
  Modelica.Blocks.Sources.BooleanStep booleanStep2(startTime=1.2e3)
...
end CS_L3_HTGR_extraction_extractions_LWR;
