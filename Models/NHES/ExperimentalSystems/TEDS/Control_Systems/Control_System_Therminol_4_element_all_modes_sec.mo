...
model Control_System_Therminol_4_element_all_modes_sec
...
parameter SI.Power Q_TES_max = 228129;
parameter SI.Power Heater_max = 260719;
parameter SI.Temperature T_hot_design = 395;
...
Medium.BaseProperties mediums;
  ...
  Modelica.Blocks.Sources.CombiTimeTable BOP_relative_demand(table=[0.0,100,1;
        1702,100,1; 3404,0,4; 4538,0,2; 6808,0,4; 9078,100,5; 10212,140,5;
        11347,140,0.0; 13616,100,0.0; 17021,100,0],
                             startTime=0)
  ...
  Modelica.Blocks.Sources.CombiTimeTable Heater_Demand(table=[0.0,1; 1539,1;
        3078,1; 4104,1; 6155,1; 7694,1; 8207,1; 9233,0; 10259,0; 12311,1; 15389,
        1],                                                   startTime=0)
...
end Control_System_Therminol_4_element_all_modes_sec;
