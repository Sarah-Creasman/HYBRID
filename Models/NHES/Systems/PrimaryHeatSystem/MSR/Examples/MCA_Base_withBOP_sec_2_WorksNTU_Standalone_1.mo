...
model MCA_Base_withBOP_sec_2_WorksNTU_Standalone_1
...
public
  ...
  Fluid.HeatExchangers.Generic_HXs.NTU_HX_SinglePhase nTU_HX_SinglePhase(
    ...
    h_start_shell_inlet=1.43e6,
    h_start_shell_outlet=1.16e6,
    dp_init_tube=0,
    dp_init_shell=1000,
    m_start_tube=221.8,
    m_start_shell=466.2)                         annotation (Placement(
        transformation(
        extent={{-10,10},{10,-10}},
        rotation=90,
        origin={286,-4})));
...
equation
  ...
  connect(pipeToSHX_PCL.port_b, nTU_HX_SinglePhase.Shell_out) annotation (Line(
        points={{290,40},{300,40},{300,20},{284,20},{284,6}}, color={0,127,255}));
  connect(nTU_HX_SinglePhase.Shell_in, pipeToPHX_PCL.port_a) annotation (Line(
        points={{284,-14},{284,-40},{240,-40}}, color={0,127,255}));
  connect(boundary4.ports[1], nTU_HX_SinglePhase.Tube_out) annotation (Line(
        points={{366,-52},{290,-52},{290,-14}}, color={0,127,255}));
  connect(boundary1.ports[1], nTU_HX_SinglePhase.Tube_in) annotation (Line(
        points={{366,30},{300,30},{300,6},{290,6}}, color={0,127,255}));
  annotation (
...
end MCA_Base_withBOP_sec_2_WorksNTU_Standalone_1;
