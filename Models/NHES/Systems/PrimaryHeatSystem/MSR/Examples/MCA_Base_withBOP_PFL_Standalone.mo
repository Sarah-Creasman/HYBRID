...
model MCA_Base_withBOP_PFL_Standalone
...
protected
 ...
 //   T=data_SHX.T_inlet_tube,
  ...
  TRANSFORM.Examples.MoltenSaltReactor.Data.Summary summary(
    ...
    m_pumpBowl_PCL=1,
    dims_pipePHXToPumpBowl_1=1,
    dims_pipePHXToPumpBowl_2=1,
    m_pipePHXToPumpBowl_PCL=1,
    dims_pipePumpBowlToSHX_1=1,
    dims_pipePumpBowlToSHX_2=1,
    m_pipePumpBowlToSHX_PCL=1,
    dims_pipeSHXToPHX_1=1,
    dims_pipeSHXToPHX_2=1,
    m_pipeSHXToPHX_PCL=1,
...
public
  ...
  TRANSFORM.Fluid.BoundaryConditions.MassFlowSource_T boundary1(
    ...
    m_flow=data_PHX.m_flow_shell,
    nPorts=1)
    annotation (Placement(transformation(extent={{268,-86},{248,-66}})));
protected
...
equation
  ...
  connect(boundary1.ports[1], PHX.port_a_shell) annotation (Line(points={{248,-76},
          {184,-76},{184,-20},{164.6,-20},{164.6,-10}}, color={0,127,255}));
  connect(PHX.port_b_shell, boundary.ports[1]) annotation (Line(points={{164.6,10},
          {164.6,20},{236,20}}, color={0,127,255}));
  annotation (
...
end MCA_Base_withBOP_PFL_Standalone;
