...
model TEDSloop_allmodes_test_sec
  ...
  Modelica.Blocks.Sources.Constant const1(k=
        control_System_Therminol_4_element_all_modes_sec.T_cold_design) annotation (
  ...
  Modelica.Blocks.Sources.Constant const(k=
        control_System_Therminol_4_element_all_modes_sec.T_hot_design) annotation (
      Placement(transformation(
        extent={{-6,-6},{6,6}},
        rotation=0,
        origin={-146,46})));
  ...
  Control_Systems.Control_System_Therminol_4_element_all_modes_sec
    control_System_Therminol_4_element_all_modes_sec(T_hot_design=668.15,
      T_cold_design=498.15)
    annotation (Placement(transformation(extent={{12,124},{42,148}})));
equation
  ...
  connect(control_System_Therminol_4_element_all_modes_sec.actuatorSubBus,
    actuatorSubBus) annotation (Line(
      points={{26.6,124.1},{26.6,106},{-31,106}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5), Text(
      string="%second",
      ...
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(control_System_Therminol_4_element_all_modes_sec.sensorSubBus,
    sensorSubBus) annotation (Line(
      points={{34,124.1},{34,106},{1,106}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5), Text(
      string="%second",
...
end TEDSloop_allmodes_test_sec;
